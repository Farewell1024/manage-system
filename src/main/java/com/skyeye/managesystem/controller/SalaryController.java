...
public class SalaryController {
    ...
    Result getOneByUserId(@ApiParam(value = "用户id", required = true) Integer userId){
    ...
    Result genAllByDate(@ApiParam(value = "年份", required = true) Integer year,
    ...
    Result deleteSalaryByUserId(@ApiParam(value = "用户id", required = true) Integer userId){
